---
title: Così l’IA e il Quantum computing cambieranno la cyber security
url: https://www.cybersecurity360.it/outlook/cosi-lia-e-il-quantum-computing-cambieranno-la-cyber-security/
source: Over Security - Cybersecurity news aggregator
date: 2026-01-14
fetch_date: 2026-01-15T03:34:27.754098
---
...
![Messaggi quantistici: verso una rete ultra sicura e accessibile; Calcolo quantistico: caratteristiche, servizi cloud e applicazioni emergenti](data:image/png;base64...)![Messaggi quantistici: verso una rete ultra sicura e accessibile; Calcolo quantistico: caratteristiche, servizi cloud e applicazioni emergenti](https://dnewpydm90vfx.cloudfront.net/wp-content/uploads/2025/03/Quantum-computing-Microsoft-Majorana-1-cyber-security.jpg)

---

L’IA sta rivoluzionando i mercati con una rapidità senza precedenti, mentre i progressi nel campo del [calcolo quantistico](https://www.cybersecurity360.it/news/quantum-italia-i-4-ambiti-del-polo-nazionale-delle-tecnologie-quantistiche/) si stanno avvicinando sempre più alla concreta applicazione.
...
I dati sono eloquenti: secondo il [Thales 2025 Data Threat Report](https://cpl.thalesgroup.com/ppc/data-threat-report?utm_source=google&utm_medium=cpc&utm_campaign=&utm_content=&utm_term=thales%20data%20threat%20report&utm_source=google&utm_medium=cpc&utm_campaign=&utm_content=&utm_term=thales%20data%20threat%20report&gad_source=1&gad_campaignid=22446323720&gclid=EAIaIQobChMIlOq3wJSVkQMVSZGDBx3vrzk1EAAYASABEgI3mfD_BwE), un terzo delle organizzazioni sta già integrando l’IA generativa nelle proprie attività, ma **il 69% riconosce che questo ecosistema, in rapida evoluzione, rappresenta la principale sfida per la sicurezza**.
...
* [Quando l’innovazione può diventare rischiosa](#Quando_linnovazione_puo_diventare_rischiosa)
* [Il calcolo quantistico: la rivoluzione che minaccia la crittografia](#Il_calcolo_quantistico_la_rivoluzione_che_minaccia_la_crittografia)
* [Le sfide di cyber security in contesti sempre più digitalizzati](#Le_sfide_di_cyber_security_in_contesti_sempre_piu_digitalizzati)
* [Prepararsi oggi per proteggersi domani](#Prepararsi_oggi_per_proteggersi_domani)
...
**L’IA agentica, in particolare, può automatizzare compiti complessi, mantenendo la supervisione umana, oltre a rendere i team di sicurezza più efficaci in un ambiente digitale sempre più pe...