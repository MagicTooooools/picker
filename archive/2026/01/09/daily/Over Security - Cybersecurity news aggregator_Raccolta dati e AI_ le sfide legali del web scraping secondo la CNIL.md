---
title: Raccolta dati e AI: le sfide legali del web scraping secondo la CNIL
url: https://www.cybersecurity360.it/news/raccolta-dati-e-ai-le-sfide-legali-del-web-scraping-secondo-la-cnil/
source: Over Security - Cybersecurity news aggregator
date: 2026-01-09
fetch_date: 2026-01-10T03:35:11.944287
---
...
![Web scraping e AI](data:image/png;base64...)![Web scraping e AI](https://dnewpydm90vfx.cloudfront.net/wp-content/uploads/2026/01/Web-scraping-e-AI.jpg)

---

Sì al [web scraping](https://www.cybersecurity360.it/cultura-cyber/web-scraping-che-cose-come-funziona-a-cosa-serve/) nella misura in cui da un lato sia **supportato da una idonea base giuridica** quale può essere, nel caso di specie, il **legittimo interesse**, e dall’altro siano state messe in atto, da parte del titolare del trattamento, **misure aggiuntive** volte a mitigare l’impatto che tale “pesca a strascico” possa avere sugli interessi, i diritti e le libertà degli utenti.

Questa è la **conditio sine qua non** e così lo afferma la CNIL, l’Autorità Garante per la privacy francese, con una [recente scheda informativa](https://www.cnil.fr/en/legal-basis-legitimate-interest-focus-sheet-measures-implement-case-data-collection-web-scraping) al riguardo.

Vediamone i tratti salienti.

Indice degli argomenti

* [Il web scraping consentito](#Il_web_scraping_consentito)
* [Il web scraping e l’AI](#Il_web_scraping_e_lAI)
* [Il web scraping e tutti i rischi per la protezione dei dati](#Il_web_scraping_e_tutti_i_rischi_per_la_protezione_dei_dati)
  + [Rischi per la privacy e i diritti garantiti dal GDPR](#Rischi_per_la_privacy_e_i_diritti_garantiti_dal_GDPR)
  + [Rischi da raccolta illegale di dati e per la libertà di espressione](#Rischi_da_raccolta_illegale_di_dati_e_per_la_liberta_di_espressione)
* [Il web scraping e le misure obbligatorie](#Il_web_scraping_e_le_misure_obbligatorie)
* [Le ragionevoli aspettative da rispettare](#Le_ragionevoli_aspettative_da_rispettare)
...
In altri casi, sono state accettate pratiche di data scraping, purchè fossero implementate misure di sicurezza rigorose. Si rammenta a proposito la [ricerca di fughe di informazioni su Internet (RIFI)](https://www.cnil.fr/fr/la-recherche-sur-internet-de-fuites-dinformations-rifi) del 2022; per quanto da allora la CNIL auspica la creazione di un quadro legislativo ad hoc (cfr. [parere della CNIL del 15 dicembre 2022 sul progetto “Polygraphe”](https://www.legifrance.gouv.fr/jorf/id/JORFTEXT000047624863)).
