---
title: Referente CSIRT: chi è, cosa fa e perché la designazione NIS2 è cruciale
url: https://www.cybersecurity360.it/legal/referente-csirt-chi-e-cosa-fa-e-perche-la-designazione-nis2-e-cruciale-nel-2025/
source: Over Security - Cybersecurity news aggregator
date: 2026-01-15
fetch_date: 2026-01-16T03:34:31.888729
---
...
La figura del referente CSIRT, introdotta dalla NIS2 e la cui designazione è formalmente scaduta lo scorso 31 dicembre 2025, rappresenta una delle innovazioni più significative introdotte dalla direttiva europea. ACN chiarisce le responsabilità e il ruolo di interfaccia con il CSIRT Italia
...
![referente csirt](data:image/png;base64...)![referente csirt](https://dnewpydm90vfx.cloudfront.net/wp-content/uploads/2025/12/Immagine-2.jpeg)

---

Una delle innovazioni più significative introdotte dalla [direttiva NIS2](https://www.cybersecurity360.it/legal/nis2-cose-quali-aziende-interessa-obblighi-e-sanzioni/) ed esplorata da ACN e Clusit durante il convegno co-organizzato, dal titolo “NIS2, pronti per la prima scadenza delle Misure di Base?”, riguarda la creazione di una **figura chiave per la comunicazione tra le organizzazioni e le autorità nazionali**: il [referente CSIRT](https://www.cybersecurity360.it/legal/nis2-nasce-il-referente-csirt-ruolo-scadenze-e-impatti-operativi-per-le-organizzazioni-italiane/).
...
* [Chi è il referente CSIRT e perché esiste](#Chi_e_il_referente_CSIRT_e_perche_esiste)
* [La designazione: timeline e modalità pratiche](#La_designazione_timeline_e_modalita_pratiche)
* [Le responsabilità del referente CSIRT](#Le_responsabilita_del_referente_CSIRT)
* [Chi può essere designato come referente CSIRT](#Chi_puo_essere_designato_come_referente_CSIRT)
* [L’interfaccia con il CSIRT Italia](#Linterfaccia_con_il_CSIRT_Italia)
* [Errori comuni da evitare](#Errori_comuni_da_evitare)
* [Le scadenze convergenti](#Le_scadenze_convergenti)

## **Chi è il referente CSIRT e perché esiste**

Il referente CSIRT è stato introdotto dalla [Determinazione ACN n. 333017/2025](https://www.cybersecurity360.it/news/la-nuova-determinazione-acn-del-31-luglio-2025-cosa-cambia-davvero-per-i-soggetti-nis/) e rappresenta una figura istituzionalizzata nell’architettura nazionale di cyber security.
...
Secondo **Aldo di Somma**, Vice Capo Divisione CSIRT Italia, il referente CSIRT svolge un compito essenziale nel sistema di **[notifica degli incidenti](https://www.cybersecurity360.it/legal/nis2-evidenze-documentali-e-obbligo-di-segnalazione-degli-incidenti-come-prepararsi/) significativi**, perché permette alle autorità di valutare con tempestività l’impatto reale di un evento.
...
La designazione avviene tramite la [piattaforma NIS](https://www.cybersecurity360.it/news/nis2-si-scaldano-i-motori-per-lavvio-operativo-pronta-la-piattaforma-di-registrazione/), dove l’organizzazione inserisce i dati della persona incaricata. Non sono previsti moduli alternativi o procedure esterne: la piattaforma è lo strumento unico attraverso cui comunicare la nomina. Per questo m...