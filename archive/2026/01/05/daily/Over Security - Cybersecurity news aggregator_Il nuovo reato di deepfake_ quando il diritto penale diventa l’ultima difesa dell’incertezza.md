---
title: Il nuovo reato di deepfake: quando il diritto penale diventa l’ultima difesa dell’incertezza
url: https://www.cybersecurity360.it/legal/il-nuovo-reato-di-deepfake-quando-il-diritto-penale-diventa-lultima-difesa-dellincertezza/
source: Over Security - Cybersecurity news aggregator
date: 2026-01-05
fetch_date: 2026-01-06T03:31:40.014458
---
...
![Nuovo reato deepfake](data:image/png;base64...)![Nuovo reato deepfake](https://dnewpydm90vfx.cloudfront.net/wp-content/uploads/2026/01/Nuovo-reato-deepfake.jpg)

---

L’approvazione della [legge italiana sull’intelligenza artificiale](https://www.cybersecurity360.it/legal/legge-sullintelligenza-artificiale-il-nuovo-quadro-normativo-italiano/) (legge 23 settembre 2025, n. 132) ha segnato l’**ingresso formale dell’IA nel sistema normativo nazionale**. È una legge composita, che si presenta come “legge quadro” ma contiene al suo interno disposizioni eterogenee: principi generali, misure di coordinamento istituzionale, incentivi all’innovazione, e, non da ultimo, **interventi di natura penale**.
...
L’idea è chiara: **disciplinare giuridicamente** il [fenomeno dei deepfake](https://www.cybersecurity360.it/nuove-minacce/i-deepfake-come-rilevarli-per-difendersi-dalla-disinformazione/) e delle manipolazioni audiovisive create con tecniche di intelligenza artificiale, prevedendo la reclusione da uno a cinque anni per chi diffonda tali contenuti arrecando un danno ingiusto a terzi.
...
* [Un reato dentro una legge “ombrello”](#Un_reato_dentro_una_legge_%E2%80%9Combrello%E2%80%9D)
* [Moltiplicazione delle norme e rarefazione dell’efficacia](#Moltiplicazione_delle_norme_e_rarefazione_dellefficacia)
* [La filosofia del controllo: un riflesso non un progetto](#La_filosofia_del_controllo_un_riflesso_non_un_progetto)
* [Norma giuridicamente incerta e tecnicamente impraticabile](#Norma_giuridicamente_incerta_e_tecnicamente_impraticabile)
* [Sovrapposizioni e conflitti normativi](#Sovrapposizioni_e_conflitti_normativi)
* [La dimensione educativa come unico terreno efficace](#La_dimensione_educativa_come_unico_terreno_efficace)
* [Il placebo della legalità](#Il_placebo_della_legalita)
...
In realtà, essa appare come un contenitore di misure tra loro molto diverse, visto che prevede la creazione di un’**Autorità nazionale per l’intelligenza artificiale**, la definizione di **codici di condotta** per i soggetti pubblici e privati che impiegano sistemi automatizzati, disposizioni per la **protezione dei minori**, e, appunto, l’[introduzione](https://www.agendadigitale.eu/documenti/giustizia-digitale/ddl-ai-cosa-cambia-se-lintelligenza-artificiale-entra-nel-codice-penale) di nuove figure di reato.
...
Un bilanciamento artificiale tra promozione e repressione: si parla di incentivi e ricerca, ma si chiude con la minaccia della pena. Si tratta di operazione politicamente comprensibile,...