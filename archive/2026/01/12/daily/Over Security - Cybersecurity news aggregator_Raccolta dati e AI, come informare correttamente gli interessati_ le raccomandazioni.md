---
title: Raccolta dati e AI, come informare correttamente gli interessati: le raccomandazioni
url: https://www.cybersecurity360.it/news/raccolta-dati-e-ai-come-informare-correttamente-gli-interessati-le-raccomandazioni/
source: Over Security - Cybersecurity news aggregator
date: 2026-01-12
fetch_date: 2026-01-13T03:33:42.764131
---
...
![AI raccolta dati informativa](data:image/png;base64...)![AI raccolta dati informativa](https://dnewpydm90vfx.cloudfront.net/wp-content/uploads/2026/01/AI-raccolta-dati-informativa.jpg)

---

L’Autorità Garante privacy francese (CNIL) ha pubblicato lo scorso 5 gennaio 2026 [linee guida](https://www.cnil.fr/en/informing-data-subjects) decisamente operative e assai dettagliate sugli **obblighi di trasparenza quando si usano sistemi di intelligenza artificiale**.

Non si tratta di novità aggiuntive o discostanti rispetto al [GDPR](https://www.cybersecurity360.it/legal/privacy-dati-personali/gdpr-una-protezione-tra-rischi-e-pericoli-per-le-persone-fisiche-e-per-leconomia/). La CNIL offre, come di consueto, una interpretazione pragmatica di come le attuali regole GDPR compliant trovano applicazione in caso di strumento di AI, e in particolare modo alle cd “attività di training”.
...
* [Raccolta dati e AI: gli impatti](#Raccolta_dati_e_AI_gli_impatti)
* [Informativa nei caso d’uso di AI: tutti gli obblighi per le aziende](#Informativa_nei_caso_duso_di_AI_tutti_gli_obblighi_per_le_aziende)
  + [Obbligo di garantire la trasparenza del trattamento](#Obbligo_di_garantire_la_trasparenza_del_trattamento)
  + [Obbligo di rendere accessibili tutte le informazioni](#Obbligo_di_rendere_accessibili_tutte_le_informazioni)
  + [Obbligo di rendere chiare le informazioni](#Obbligo_di_rendere_chiare_le_informazioni)
* [L’informativa nei caso d’uso di AI: le due deroghe](#Linformativa_nei_caso_duso_di_AI_le_due_deroghe)
  + [L’interessato ha già ottenuto le informazioni sul trattamento per finalità di sviluppo](#Linteressato_ha_gia_ottenuto_le_informazioni_sul_trattamento_per_finalita_di_sviluppo)
  + [L’informazione richiederebbe uno sforzo sproporzionato](#Linformazione_richiederebbe_uno_sforzo_sproporzionato)
...
Evidentemente sì purché siano “**facilmente a...