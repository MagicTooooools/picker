---
title: Gestire il rischio cyber dei sistemi di AI: le prime indicazioni operative del NIST
url: https://www.cybersecurity360.it/soluzioni-aziendali/gestire-il-rischio-cyber-dei-sistemi-di-ai-le-prime-indicazioni-operative-del-nist/
source: Over Security - Cybersecurity news aggregator
date: 2026-01-12
fetch_date: 2026-01-13T03:33:45.643861
---
...
![AI cyber risk governance](data:image/png;base64...)![AI cyber risk governance](https://dnewpydm90vfx.cloudfront.net/wp-content/uploads/2026/01/AI-cyber-risk-governance.jpg)

---

L’**intelligenza artificiale è ormai dentro i processi, le infrastrutture e le decisioni delle organizzazioni**. Il suo [impatto sulla cyber security](https://www.cybersecurity360.it/nuove-minacce/ai-e-cybersecurity-lintelligenza-artificiale-e-sia-risorsa-sia-minaccia-per-la-sicurezza-digitale/) è profondo e strutturale e va assunto come questione di governance.

In tale quadro, il NIST ha pubblicato una prima bozza del [Cyber AI Profile (NIST IR 8596 iprd)](https://csrc.nist.gov/pubs/ir/8596/iprd) al fine di fornire **linee guida per gestire il rischio di cyber security legato ai sistemi di AI** e, contestualmente, individuare opportunità per **usare l’AI a rafforzamento delle capacità di difesa cyber**.
...
* [L’AI non è mai neutra per la sicurezza](#LAI_non_e_mai_neutra_per_la_sicurezza)
* [Un documento in divenire che indica già la direzione](#Un_documento_in_divenire_che_indica_gia_la_direzione)
* [Cyber AI Profile: il NIST CSF 2.0 applicato all’AI](#Cyber_AI_Profile_il_NIST_CSF_20_applicato_allAI)
* [Cos’è un “Profile” nel NIST CSF 2.0](#Cose_un_%E2%80%9CProfile%E2%80%9D_nel_NIST_CSF_20)
* [Le tre aree di attenzione: proteggere, difendere, contrastare](#Le_tre_aree_di_attenzione_proteggere_difendere_contrastare)
  + [Proteggere i componenti dei sistemi di AI](#Proteggere_i_componenti_dei_sistemi_di_AI)
  + [Condurre una difesa informatica basata sull’intelligenza artificiale](#Condurre_una_difesa_informatica_basata_sullintelligenza_artificiale)
  + [Contrastare gli attacchi informatici basati sull’intelligenza artificiale](#Contrastare_gli_attacchi_informatici_basati_sullintelligenza_artificiale)
* [Le tre aree non sono indipendenti](#Le_tre_aree_non_sono_indipendenti)
...
2. dall’altro **rappresenta comunque una presa di posizione uffici...