---
title: 网盘简单私密的文件共享在线文件传输工具
url: https://mp.weixin.qq.com/s/EDBIriCXhqYQYdJjp3ZGVA
source: Doonsec's feed
date: 2026-01-06
fetch_date: 2026-01-07T03:29:21.068634
---

# 网盘简单私密的文件共享在线文件传输工具

![cover_image](https://mmbiz.qpic.cn/sz_mmbiz_jpg/0YvAy5BgkyPeyuibquhbShYv8oZBc9ibreyM0UWuPFhs9eCcmWcFPLfyIvHFXVThuhn1WibbJmr0PXAkLgyZkHkvQ/0?wx_fmt=jpeg)
...
平时分享文件，用的到大多数是百度网盘（没有会员下载速度会很慢），还有就是微信(大文件无法分享)直接发送传输文件。

笔者这里发现一个端到端加密和自动过期链接的方式分享文件的在线文件传输工具（文件最大可达 10 GB）

![](https://mmbiz.qpic.cn/sz_mmbiz_png/0YvAy5BgkyPeyuibquhbShYv8oZBc9ibre4Nu65XuGnZgXsPqQN3kD9L4TXOnRFFDibbz1F3fZJr67jWicjicUD2yRA/640?wx_fmt=png&from=appmsg)

```
✔ 端到端加密，让分享更安全✔ 自动过期链接，可控制生命周期✔ 可通过浏览器直接使用，无需安装✔ 适合分享大文件或敏感文件
```

除了上传文件 还可以上传文件夹  或者压缩包等等也是很方便

![](https://mmbiz.qpic.cn/sz_mmbiz_png/0YvAy5BgkyPeyuibquhbShYv8oZBc9ibreG2RCu8hdVEALJOmGh5MuReEaRfK9w3UNCDOM47R2Ff5icQkLDMPpolA/640?wx_fmt=png&from=appmsg)

上传动画也很炫酷

当时这个也有自己的app，我目前没用到 有需要的也可以直接用app试试

有需要的小伙伴可以试试，这种简单的传输共享方式 我感觉非常不错 而且很实用 感兴趣的小伙伴试试吧

地址：https://wormhole.app
