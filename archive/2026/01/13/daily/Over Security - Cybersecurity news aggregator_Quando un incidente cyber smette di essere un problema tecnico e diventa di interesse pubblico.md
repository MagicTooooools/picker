---
title: Quando un incidente cyber smette di essere un problema tecnico e diventa di interesse pubblico
url: https://www.cybersecurity360.it/legal/quando-un-incidente-cyber-smette-di-essere-un-problema-tecnico-e-diventa-di-interesse-pubblico/
source: Over Security - Cybersecurity news aggregator
date: 2026-01-13
fetch_date: 2026-01-14T03:38:56.946549
---
...
![NIS2 e CdA; Linee guida NIS : il nuovo quadro normativo per la risposta agli incidenti; Nis 2, un nuovo modo di leggere gli incidenti informatici](data:image/png;base64...)![NIS2 e CdA; Linee guida NIS : il nuovo quadro normativo per la risposta agli incidenti; Nis 2, un nuovo modo di leggere gli incidenti informatici](https://dnewpydm90vfx.cloudfront.net/wp-content/uploads/2025/12/Immagine-19.jpeg)

---

La **[Direttiva NIS 2](https://www.cybersecurity360.it/legal/nis2-cose-quali-aziende-interessa-obblighi-e-sanzioni/)** e il D.lgs. 138/2024 hanno introdotto un cambiamento profondo per i soggetti rientranti nel perimetro e in termini di obblighi di gestione e [notifica degli incidenti informatici](https://www.cybersecurity360.it/legal/differenze-fra-nis-2-gdpr-notifica-incidenti-gestione-supply-chain/).
...
* [Un nuovo modo di leggere gli incidenti informatici](#Un_nuovo_modo_di_leggere_gli_incidenti_informatici)
* [Dalla normalità operativa alla rilevanza sistemica](#Dalla_normalita_operativa_alla_rilevanza_sistemica)
* [L’incidente informatico come fatto di interesse pubblico](#Lincidente_informatico_come_fatto_di_interesse_pubblico)
* [Il comma 8 dell’articolo 25: una norma breve con un impatto enorme](#Il_comma_8_dellarticolo_25_una_norma_breve_con_un_impatto_enorme)
* [Quando un incidente assume rilevanza penalistica](#Quando_un_incidente_assume_rilevanza_penalistica)
* [Il ruolo del CSIRT: supporto, orientamento, responsabilità istituzionale](#Il_ruolo_del_CSIRT_supporto_orientamento_responsabilita_istituzionale)
* [Dal CSIRT alla Polizia di Stato, fino alla Procura della Repubblica](#Dal_CSIRT_alla_Polizia_di_Stato_fino_alla_Procura_della_Repubblica)
* [La procedura per la gestione degli incidenti](#La_procedura_per_la_gestione_degli_incidenti)
* [La sicurezza come prova di maturità organizzativa](#La_sicurezza_come_prova_di_maturita_organizzativa)
