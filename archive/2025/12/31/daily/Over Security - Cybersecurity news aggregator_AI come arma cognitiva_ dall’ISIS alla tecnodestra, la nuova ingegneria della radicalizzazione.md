---
title: AI come arma cognitiva: dall’ISIS alla tecnodestra, la nuova ingegneria della radicalizzazione
url: https://www.cybersecurity360.it/nuove-minacce/ai-come-arma-cognitiva-dallisis-alla-tecnodestra-la-nuova-ingegneria-della-radicalizzazione/
source: Over Security - Cybersecurity news aggregator
date: 2025-12-31
fetch_date: 2026-01-01T03:38:03.604655
---
...
![IA ISIS e tecnodestra](data:image/png;base64...)![IA ISIS e tecnodestra](https://dnewpydm90vfx.cloudfront.net/wp-content/uploads/2025/12/IA-ISIS-e-tecnodestra.jpg)

---

Alcune [recenti inchieste](https://it.euronews.com/next/2025/12/15/isis-e-altri-gruppi-estremisti-usano-lia-per-creare-contenuti-falsi-e-reclutare-nuovi-memb) hanno riportato al centro del dibattito un fenomeno che, pur non essendo del tutto nuovo, sta assumendo caratteristiche radicalmente diverse e di cui si parla poco: l’**uso dell’intelligenza artificiale da parte di ISIS e di altri gruppi estremisti** per creare contenuti falsi, diffondere propaganda online e reclutare nuovi membri.
...
Secondo quanto riportato dalle fonti giornalistiche, le organizzazioni jihadiste starebbero infatti sperimentando [strumenti di intelligenza artificiale generativa](https://www.cybersecurity360.it/nuove-minacce/man-in-the-prompt-la-nuova-minaccia-invisibile-nei-browser-con-ai-integrata/) per produrre testi, immagini e soprattutto video sempre più sofisticati, capaci di **apparire credibili e coerenti con i linguaggi contemporanei delle piattaforme social**.
...
* [L’IA moltiplicatore di forza cognitiva](#LIA_moltiplicatore_di_forza_cognitiva)
* [Come i gruppi estremisti usano oggi l’IA](#Come_i_gruppi_estremisti_usano_oggi_lIA)
* [Interazioni sintetiche e manipolazione cognitiva](#Interazioni_sintetiche_e_manipolazione_cognitiva)
* [Video, deepfake e propaganda: perché l’impatto è diverso dal passato](#Video_deepfake_e_propaganda_perche_limpatto_e_diverso_dal_passato)
* [Reclutamento personalizzato e radicalizzazione assistita da algoritmi](#Reclutamento_personalizzato_e_radicalizzazione_assistita_da_algoritmi)
* [Non solo ISIS: l’IA come strumento politico radicale](#Non_solo_ISIS_lIA_come_strumento_politico_radicale)
* [Curtis Yarvin, tecnodestra e immaginari post-democratici](#Curtis_Yarvin_tecnodestra_e_immaginari_post-democratici)
* [Un problema tutt’altro che marginale](#Un_problema_tuttaltro_che_marginale)
* [Quali risposte sono realistiche (e quali no)](#Quali_risposte_sono_realistiche_e_quali_no)

## L’IA moltiplicatore di forza cognitiva

L’aspetto più rilevante delle inchieste citate è la constatazione che gli strumenti AI abbiano [abbassato drasticamente le barriere all’ingresso](https://www.cybersecurity360.it/nuove-minacce/manipolazione-dei-prompt-la-bassasoglia-di-accesso-apre-il-vaso-di-pandora/).
...
[Come confermato da fonti giornalistiche internazionali](https://apnews.com/article/islamic-state-group-artificial-intelligence-deepfakes-ba201d23b91dbab95f6a8e7ad8b778d5), l’intelligenza artificiale sta diventando un moltiplicatore di capacità per attori estremisti che operano prevalentemente nello spazio informativo.
