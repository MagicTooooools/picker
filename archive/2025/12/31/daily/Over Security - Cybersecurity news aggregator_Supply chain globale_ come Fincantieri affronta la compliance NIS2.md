---
title: Supply chain globale: come Fincantieri affronta la compliance NIS2
url: https://www.cybersecurity360.it/legal/supply-chain-globale-come-fincantieri-affronta-la-compliance-nis2/
source: Over Security - Cybersecurity news aggregator
date: 2025-12-31
fetch_date: 2026-01-01T03:38:01.248254
---
...
La compliance NIS2 sta trasformando la gestione della sicurezza nelle grandi filiere industriali. L’esperienza maturata da Fincantieri evidenzia la complessità di coordinare migliaia di fornitori globali, diffondere consapevolezza e integrare requisiti di sicurezza nei contratti. Governance, formazione e dialogo diventano strumenti essenziali per costruire una supply chain realmente resiliente
...
![compliance_nis2_cybersecurity360](data:image/png;base64...)![compliance_nis2_cybersecurity360](https://dnewpydm90vfx.cloudfront.net/wp-content/uploads/2025/11/Immagine-3.jpeg)

---

Il [percorso di adeguamento alla direttiva europea NIS2](https://www.agendadigitale.eu/sicurezza/obblighi-di-cyber-sicurezza-come-adeguarsi-alla-direttiva-nis2/) sta trasformando la gestione della sicurezza nelle grandi filiere industriali. Durante la presentazione del Rapporto Clusit 2025, **Valeria Prosser**, Head of Governance, Risk & Compliance di E-phors S.p.A., ha illustrato come la sicurezza della supply chain sia diventata una componente strutturale della compliance, condividendo l’esperienza maturata anche nel contesto di Fincantieri, gruppo manifatturiero globale con oltre 5.400 fornitori qualificati.

Indice degli argomenti

* [La dimensione del rischio: una supply chain da 5.400 fornitori](#La_dimensione_del_rischio_una_supply_chain_da_5400_fornitori)
* [La compliance NIS2 come relazione: trasferire cultura ai fornitori](#La_compliance_NIS2_come_relazione_trasferire_cultura_ai_fornitori)
* [Contratti e governance: la sicurezza come requisito operativo](#Contratti_e_governance_la_sicurezza_come_requisito_operativo)
* [Una supply chain globale: armonizzare linguaggi e pratiche](#Una_supply_chain_globale_armonizzare_linguaggi_e_pratiche)
* [La notifica degli incidenti come strumento di resilienza](#La_notifica_degli_incidenti_come_strumento_di_resilienza)
* [Oltre la conformità: verso una sicurezza sostenibile e adattiva](#Oltre_la_conformita_verso_una_sicurezza_sostenibile_e_adattiva)
...
Uno degli aspetti più significativi emersi dalle parole di Prosser riguarda la dimensione collaborativa della [compliance NIS2](https://www.innovationpost.it/sponsored-content/la-nis-2-per-il-manufacturing-non-solo-obblighi-ma-anche-opportunita/). Molti fornitori, soprattutto quelli esteri o di piccole dimensioni, non conoscono la direttiva o non ne comprendono l’impatto. «Le negoziazioni si aprono spesso con una sorta di introduzione alla normativa», spiega. Il ruolo delle grandi aziende diventa quindi duplice: garantire il proprio adeguamento e diffondere conoscenza e consapevolezza lungo la filiera.

Prosser chiarisce un equivoco frequente: «Non chiediamo ai fornitori che non sono direttamente soggetti NIS2 di adeguarsi alla direttiva; condividiamo con loro i requisiti di sicurezza che per noi, in qualità di s...