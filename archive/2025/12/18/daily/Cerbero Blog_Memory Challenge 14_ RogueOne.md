---
title: Memory Challenge 14: RogueOne
url: https://blog.cerbero.io/memory-challenge-14-rogueone/
source: Cerbero Blog
date: 2025-12-18
fetch_date: 2025-12-19T03:23:51.439986
---
...
[](/wp-content/uploads/2025/11/rogueone_challenge.mp4)

We found this challenge on the [Memory Forensic site](https://memoryforensic.com/rogueone-challenge/), so credit goes to them for highlighting it and to [Hack The Box](https://app.hackthebox.com/sherlocks/RogueOne) for creating it in the first place.
...
We identify the malicious process, the remote address of the C2 server, and the time the connection was created. As a bonus, we also identify a PE injected into the malicious process and load it into our workspace.

![](https://secure.gravatar.com/avatar/7a86aa69922858b8d41989621fc1ea364aae1e027546f88a54d94ab1ec2187fc?s=49&d=mm&r=g)Author [Erik Pistelli](https://blog.cerbero.io/author/cerbero/)Posted on [December 18, 2025](https://blog.cerbero.io/memory-challenge-14-rogueone/)Categories [Video](https://blog.cerbero.io/category/video/)Tags [Challenge](https://blog.cerbero.io/tag/challenge/), [Memory Forensics](https://blog.cerbero.io/tag/memory-forensics/), [windows](https://blog.cerbero.io/tag/windows/)

## Leave a Reply [Cancel reply](/memory-challenge-14-rogueone/#respond)
...
[Previous Previous post: Memory Challenge 13: TeamSpy](https://blog.cerbero.io/memory-challenge-13-teamspy/)
