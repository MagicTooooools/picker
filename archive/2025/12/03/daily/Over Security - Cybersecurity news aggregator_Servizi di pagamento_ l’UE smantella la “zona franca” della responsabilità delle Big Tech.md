---
title: Servizi di pagamento: l’UE smantella la “zona franca” della responsabilità delle Big Tech
url: https://www.cybersecurity360.it/legal/servizi-di-pagamento-lue-smantella-la-zona-franca-della-responsabilita-delle-big-tech/
source: Over Security - Cybersecurity news aggregator
date: 2025-12-03
fetch_date: 2025-12-04T03:22:06.940454
---
...
![Regolamento sui Servizi di pagamento](data:image/png;base64...)![Regolamento sui Servizi di pagamento](https://dnewpydm90vfx.cloudfront.net/wp-content/uploads/2025/12/Regolamento-sui-Servizi-di-pagamento.jpg)

---

Il 21 novembre 2025 il Parlamento europeo ha diffuso un [comunicato](https://www.europarl.europa.eu/news/en/press-room/20251121IPR31540/payment-services-deal-more-protection-from-online-fraud-and-hidden-fees) che segna un passaggio importante nel **modo in cui l’Unione affronta la sicurezza dei pagamenti digitali**.

L’accordo provvisorio raggiunto con il Consiglio sul **nuovo Regolamento sui Servizi di Pagamento (Payment Services Regulation, PSR)** oltre ad essere un aggiornamento tecnico del quadro normativo esistente e a rappresentare un’estensione naturale della [PSD2](https://www.cybersecurity360.it/legal/psd3-e-sicurezza-dei-pagamenti-digitali-cosi-cambieranno-strumenti-e-abitudini-dei-consumatori/), costituisce un mutamento di prospettiva.
...
Il [terreno di coltura delle truffe](https://www.cybersecurity360.it/nuove-minacce/truffe-online-le-piu-diffuse-come-riconoscerle-e-i-consigli-per-difendersi/) si è spostato verso un ecosistema molto meno controllato, cioè quello dei social media, delle piattaforme di video-sharing, dei marketplace e delle app di messaggistica.
...
* [Il fallimento del perimetro tradizionale](#Il_fallimento_del_perimetro_tradizionale)
* [La scelta politica del PSR: proteggere il cliente e accelerare la sicurezza bancaria](#La_scelta_politica_del_PSR_proteggere_il_cliente_e_accelerare_la_sicurezza_bancaria)
* [Il terzo attore entra nella scena della sicurezza finanziaria](#Il_terzo_attore_entra_nella_scena_della_sicurezza_finanziaria)
* [Il meccanismo di rivalsa: una nuova architettura di responsabilità](#Il_meccanismo_di_rivalsa_una_nuova_architettura_di_responsabilita)
* [PSR e DSA: due norme che rischiano di contraddirsi](#PSR_e_DSA_due_norme_che_rischiano_di_contraddirsi)
* [L’onere tecnologico ricade sulle piattaforme](#Lonere_tecnologico_ricade_sulle_piattaforme)
* [La dimensione geopolitica: un nuovo fronte del confronto USA-UE](#La_dimensione_geopolitica_un_nuovo_fronte_del_confronto_USA-UE)
* [Chi costruirà il protocollo tecnico?](#Chi_costruira_il_protocollo_tecnico)
* [Un nuovo sistema di responsabilità digitale](#Un_nuovo_sistema_di_responsabilita_digitale)
