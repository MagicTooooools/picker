---
title: Quando il dato viaggia chiuso: la non responsabilità del servizio di recapito
url: https://www.cybersecurity360.it/legal/privacy-dati-personali/quando-il-dato-viaggia-chiuso-la-non-responsabilita-del-servizio-di-recapito/
source: Over Security - Cybersecurity news aggregator
date: 2025-12-19
fetch_date: 2025-12-20T03:19:23.093860
---
...
![Interazione DSA GDPR_shutterstock_2573650401; Quando il dato viaggia chiuso: perché il corriere non è né titolare né responsabile del trattamento](data:image/png;base64...)![Interazione DSA GDPR_shutterstock_2573650401; Quando il dato viaggia chiuso: perché il corriere non è né titolare né responsabile del trattamento](https://dnewpydm90vfx.cloudfront.net/wp-content/uploads/2025/09/Interazione-DSA-GDPR_shutterstock_2573650401.jpg)
...
Ecco un principio cardine della protezione dei dati personali: l**a responsabilità non nasce dalla prossimità fisica al dato, ma dal potere di governarlo**.
...
* [Il GDPR non segue le mani che toccano i dati ma il potere che li governa](#Il_GDPR_non_segue_le_mani_che_toccano_i_dati_ma_il_potere_che_li_governa)
  + [Una compliance matura](#Una_compliance_matura)
* [Il possesso non è trattamento](#Il_possesso_non_e_trattamento)
* [Il corriere come semplice canale di trasmissione](#Il_corriere_come_semplice_canale_di_trasmissione)
  + [Il ruolo della responsabilità nel diritto della protezione dei dati](#Il_ruolo_della_responsabilita_nel_diritto_della_protezione_dei_dati)
* [La responsabilità segue il potere, non la vicinanza](#La_responsabilita_segue_il_potere_non_la_vicinanza)
* [Lo smarrimento come esito di una scelta organizzativa e della connessa valutazione del rischio](#Lo_smarrimento_come_esito_di_una_scelta_organizzativa_e_della_connessa_valutazione_del_rischio)
* [Quando il corriere diventa titolare a pieno titolo](#Quando_il_corriere_diventa_titolare_a_pieno_titolo)
* [La lezione da trarre dal caso del corriere e GDPR](#La_lezione_da_trarre_dal_caso_del_corriere_e_GDPR)
...
È una semplificazione che rassicura perché offre un confine netto e apparentemente facile da comprendere, ma proprio per questo, però, secondo me, è fuorvian...