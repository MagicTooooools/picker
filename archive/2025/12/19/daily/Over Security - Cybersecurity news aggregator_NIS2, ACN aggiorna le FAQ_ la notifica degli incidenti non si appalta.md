---
title: NIS2, ACN aggiorna le FAQ: la notifica degli incidenti non si appalta
url: https://www.cybersecurity360.it/legal/nis2-acn-aggiorna-le-faq-la-notifica-degli-incidenti-non-si-appalta/
source: Over Security - Cybersecurity news aggregator
date: 2025-12-19
fetch_date: 2025-12-20T03:19:14.081076
---
...
![NIS2 determinazione ACN 31 luglio 2025; Governare il rischio di cyber sicurezza nell'impresa: il ruolo degli amministratori, fra obblighi e responsabilità; NIS2, ACN aggiorna le FAQ: la notifica degli incidenti non si appalta](data:image/png;base64...)![NIS2 determinazione ACN 31 luglio 2025; Governare il rischio di cyber sicurezza nell'impresa: il ruolo degli amministratori, fra obblighi e responsabilità; NIS2, ACN aggiorna le FAQ: la notifica degli incidenti non si appalta](https://dnewpydm90vfx.cloudfront.net/wp-content/uploads/2025/08/NIS2-determinazione-ACN-31-luglio-2025.jpg)
...
Sulla [NIS2](https://www.cybersecurity360.it/legal/nis2-cose-quali-aziende-interessa-obblighi-e-sanzioni/), le **nuove FAQ di ACN** servono proprio a questo: **eliminare l’ambiguità su chi deve notificare al CSIRT Italia quando l’incidente coinvolge una relazione cliente–fornitore tra soggetti NIS** e quando entrano in gioco **servizi cloud**.
...
* [Il punto vero: “chi rileva” non coincide con “chi notifica”](#Il_punto_vero_%E2%80%9Cchi_rileva%E2%80%9D_non_coincide_con_%E2%80%9Cchi_notifica%E2%80%9D)
  + [Scenario 1 (FAQ ISB.F.1): incidente sui sistemi del cliente, con fornitore che eroga servizi](#Scenario_1_FAQ_ISBF1_incidente_sui_sistemi_del_cliente_con_fornitore_che_eroga_servizi)
  + [Scenario 2 (FAQ ISB.F.2): incidente sui sistemi del fornitore, con impatto sul cliente](#Scenario_2_FAQ_ISBF2_incidente_sui_sistemi_del_fornitore_con_impatto_sul_cliente)
  + [Scenario 3 (FAQ ISB.F.3): cloud tra soggetti NIS, e l’eccezione che conta](#Scenario_3_FAQ_ISBF3_cloud_tra_soggetti_NIS_e_leccezione_che_conta)
  + [Registrazione nei gruppi (FAQ 3.15): la scorciatoia “di gruppo” non esiste](#Registrazione_nei_gruppi_FAQ_315_la_scorciatoia_%E2%80%9Cdi_gruppo%E2%80%9D_non_esiste)
* [La NIS2 entra davvero nella fase operativa e toglie alibi](#La_NIS2_entra_davvero_nella_fase_operativa_e_toglie_alibi)
...
Questo non è un dettaglio da giuristi: è la differenza tra un processo che regge sotto stress e un processo che collassa nel momento peggiore, quando devi decidere in poche ...