---
title: Dall’era delle password all’autenticazione resistente al phishing: la guida NIST
url: https://www.cybersecurity360.it/soluzioni-aziendali/dallera-delle-password-allautenticazione-resistente-al-phishing-la-guida-nist/
source: Over Security - Cybersecurity news aggregator
date: 2025-12-24
fetch_date: 2025-12-25T03:29:53.249715
---
...
![Linee guida NIST identità digitale](data:image/png;base64...)![Linee guida NIST identità digitale](https://dnewpydm90vfx.cloudfront.net/wp-content/uploads/2025/12/Linee-guida-NIST-identita-digitale.jpg)

---

Il NIST ha rilasciato la versione finale della **[SP 800-63-4 Digital Identity Guidelines](https://pages.nist.gov/800-63-4/)**, di fatto le **linee guida più autorevoli per l’uso delle password e della gestione delle identità digitali**.

Questa quarta versione va ad aggiornare la precedente [Special Publication NIST SP 800-63-3 pubblicata nel 2017](https://www.cybersecurity360.it/soluzioni-aziendali/sicurezza-delle-password-le-nuove-regole-del-nist-per-renderle-inattaccabili/).
...
* **[SP 800-63-4 Digital Identity Guidelines](https://csrc.nist.gov/pubs/sp/800/63/4/final)** (86 pagine);
* **[SP 800-63A-4 Identity Proofing & Enrollment](https://csrc.nist.gov/pubs/sp/800/63/A/4/final)** (102 pagine);
* **[SP 800-63B-4 Authentication & Authenticator Management](https://csrc.nist.gov/pubs/sp/800/63/B/4/final)** (118 pagine);
* **[SP 800-63C-4 Federation & Assertions](https://csrc.nist.gov/pubs/sp/800/63/C/4/final)** (137 pagine).
...
Il primo “PRE-DRAFT Call for Comments” di questo documento fu pubblicato a giugno 2020, mentre la prima bozza è datata 16 dicembre 2022, quando il NIST ha pubblicato l’[Initial Public Draft](https://csrc.nist.gov/pubs/sp/800/63/4/ipd) (IPD) del documento SP 800-63, Revisione 4.
...
* [Cosa è la NIST Special Publication 800-63: la storia](#Cosa_e_la_NIST_Special_Publication_800-63_la_storia)
* [Linee guida per l’identità digitale: com’è strutturata la NIST SP 800-63-4](#Linee_guida_per_lidentita_digitale_come_strutturata_la_NIST_SP_800-63-4)
* [Linee guida NIST per l’identità digitale: gli aspetti più interessanti](#Linee_guida_NIST_per_lidentita_digitale_gli_aspetti_piu_interessanti)
* [Nuove raccomandazioni per autenticazione resistente al phishing](#Nuove_raccomandazioni_per_autenticazione_resistente_al_phishing)
  + [Cosa significa “phishing‑resistant”](#Cosa_significa_%E2%80%9Cphishing%E2%80%91resistant%E2%80%9D)
  + [Cosa viene sconsigliato](#Cosa_viene_sconsigliato)
* [SP 800-63B Authentication & Authenticator Management: punti di interesse](#SP_800-63B_Authentication_Authenticator_Management_punti_di_interesse)
  + [Misure di sicurezza da adottare per la corretta autenticazione](#Misure_di_sicurezza_da_adottare_per_la_corretta_autenticazione)
  + [Standard per l’utilizzo corretto delle password](#Standard_per_lutilizzo_corretto_delle_password)
  + [Qual è la corretta lunghezza di una password](#Qual_e_la_corretta_lunghezza_di_una_password)
  + [Regole basilari per la creazione di una password](#Regole_basilari_per_la_creazione_di_una_password)
  + [Il NIST depreca le “domande di sicurezza”](#Il_NIST_depreca_le_%E2%80%9Cdomande_di_sicurezza%E2%80%9D)
  + [Il consiglio del NIST: usare i password manager](#Il_consiglio_del...