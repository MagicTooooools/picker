---
title: Ransomware, il 23% delle vittime paga il riscatto (e gli attaccanti corrono ai ripari)
url: https://www.cybersecurity360.it/news/ransomware-23-vittime-paga/
source: Over Security - Cybersecurity news aggregator
date: 2025-12-01
fetch_date: 2025-12-02T03:21:29.998262
---
...
![Cala il numero delle imprese che pagano riscatti e diminuisce anche l'importo richiesto dagli aggressori che mettono a segno campagne ransomware](data:image/png;base64...)![Cala il numero delle imprese che pagano riscatti e diminuisce anche l'importo richiesto dagli aggressori che mettono a segno campagne ransomware](https://dnewpydm90vfx.cloudfront.net/wp-content/uploads/2025/11/ransomware-e-riscatti.jpg)
...
Questo è ciò che emerge da un’[indagine di Coveware](https://www.coveware.com/blog/2025/10/24/insider-threats-loom-while-ransom-payment-rates-plummet), società specializzata nella risposta agli [attacchi ransomware](https://www.cybersecurity360.it/news/ransomware-in-crescita-via-campagne-malware-basate-sullai-come-mitigare-il-rischio/).
...
* [I ransomware e lo spray and pray](#I_ransomware_e_lo_spray_and_pray)
* [Il cielo si schiarisce](#Il_cielo_si_schiarisce)
* [Il ricorso agli insider](#Il_ricorso_agli_insider)
* [I vettori e le tattiche ricorrenti](#I_vettori_e_le_tattiche_ricorrenti)
* [I collettivi più attivi](#I_collettivi_piu_attivi)

## I ransomware e lo spray and pray

Coveware ha osservato **una spaccatura nel panorama** delle cyber estorsioni.

Da una parte continuano le [campagne Ransomware-as-a-Service (RaaS)](https://www.cybersecurity360.it/outlook/ransomware-as-a-service-cosa-sono-e-come-funzionano/) che puntano al volume. È [il caso di Akira](https://www.cybersecurity360.it/nuove-minacce/ransomware/akira-il-ransomware-a-cui-piacciono-le-pmi/) che sfrutta vulnerabilità note sferrando attacchi a piccole realtà aziendali in quantità tale da garantire il pagamento di un numero più elevato di riscatti, ancorché di importi relativamente piccoli.
...
Inoltre, il report di Coveware sottolinea che **pagare per scongiurare la fuga di dati non è più ammesso dalle best practice**, anche nel caso in cui la cifra in richiesta dai cr...