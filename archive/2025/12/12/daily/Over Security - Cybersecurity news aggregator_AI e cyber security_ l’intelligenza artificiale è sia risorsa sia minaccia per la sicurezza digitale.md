---
title: AI e cyber security: l’intelligenza artificiale è sia risorsa sia minaccia per la sicurezza digitale
url: https://www.cybersecurity360.it/nuove-minacce/ai-e-cybersecurity-lintelligenza-artificiale-e-sia-risorsa-sia-minaccia-per-la-sicurezza-digitale/
source: Over Security - Cybersecurity news aggregator
date: 2025-12-12
fetch_date: 2025-12-13T03:19:59.568869
---
...
![ai_e_cybersecurity_cybersecurity360](data:image/png;base64...)![ai_e_cybersecurity_cybersecurity360](https://dnewpydm90vfx.cloudfront.net/wp-content/uploads/2025/11/Immagine-5.jpeg)

---

L’[intelligenza artificiale sta ridefinendo in profondità il panorama della sicurezza informatica](https://www.cybersecurity360.it/cultura-cyber/cosi-lintelligenza-artificiale-sta-rivoluzionando-la-cyber-security/). Non solo come strumento difensivo, ma anche come leva operativa per gli attaccanti.
...
* [Dalla difesa all’offesa: la nuova strategia del cybercrime](#Dalla_difesa_alloffesa_la_nuova_strategia_del_cybercrime)
* [Deepfake e contenuti manipolati: la fine della fiducia visiva](#Deepfake_e_contenuti_manipolati_la_fine_della_fiducia_visiva)
* [L’intelligenza artificiale come amplificatore di rischio](#Lintelligenza_artificiale_come_amplificatore_di_rischio)
* [Una minaccia alla stabilità economica: cybersecurity e sostenibilità](#Una_minaccia_alla_stabilita_economica_cybersecurity_e_sostenibilita)
* [Formazione e consapevolezza: il fattore umano come barriera](#Formazione_e_consapevolezza_il_fattore_umano_come_barriera)
* [Verso un nuovo equilibrio tra intelligenza artificiale e sicurezza](#Verso_un_nuovo_equilibrio_tra_intelligenza_artificiale_e_sicurezza)

## **Dalla difesa all’offesa: la nuova strategia del cybercrime**

Per anni l’[AI è stata descritta come una risorsa chiave per il rafforzamento delle difese digitali](https://www.cybersecurity360.it/nuove-minacce/sfruttare-lintelligenza-artificiale-e-il-machine-learning-per-una-difesa-cyber-proattiva/): algoritmi di machine learning per il rilevamento delle anomalie, analisi predittive dei rischi, automazione delle risposte agli incidenti.
...
La [manipolazione di immagini, voci e video](https://www.cybersecurity360.it/nuove-minacce/i-deepfake-come-rilevarli-per-difendersi-dalla-disinformazione/) genera un ulteriore livello di rischio. Secondo Pennasilico, «oggi le tecniche di deepfake non sono più curio...