---
title: ACN: il report di novembre conferma un quadro di minaccia “a fisarmonica”
url: https://www.cybersecurity360.it/news/operational-summary-acn-novembre-2025/
source: Over Security - Cybersecurity news aggregator
date: 2025-12-30
fetch_date: 2025-12-31T03:28:36.082570
---
...
![Report di febbraio di Acn: ecosistema italiano più resiliente, ecco i settori con più vittime; Acn: il report di novembre conferma un quadro di minaccia “a fisarmonica”](data:image/png;base64...)![Report di febbraio di Acn: ecosistema italiano più resiliente, ecco i settori con più vittime; Acn: il report di novembre conferma un quadro di minaccia “a fisarmonica”](https://dnewpydm90vfx.cloudfront.net/wp-content/uploads/2024/11/ACN-Operational-Summary-ottobre-2024-e1734701153578.jpg)

---

Secondo il [rapporto mensile](https://www.cybersecurity360.it/news/acn-a-ottobre-preoccupa-la-persistenza-di-esposizioni-di-dati-in-pa-telco-e-finanza/) di CSIRT Italia, a [novembre](https://www.acn.gov.it/portale/w/operational-summary-novembre-2025) gli eventi cyber sono in calo a doppia cifra.
...
* [Operational summary ACN: i settori più colpiti a novembre](#Operational_summary_ACN_i_settori_piu_colpiti_a_novembre)
  + [Pmi del manifatturiero nel mirino](#Pmi_del_manifatturiero_nel_mirino)
* [Un’azione preventiva sempre più matura](#Unazione_preventiva_sempre_piu_matura)
  + [Una difesa sempre più industrializzata](#Una_difesa_sempre_piu_industrializzata)
...
Infatti, il numero di **eventi** cyber calano rispetto ai 267del mese precedente. Invece gli **incidenti**(**54**) aumentanodel 13% rispetto ad ottobre. E **Pubblica amministrazione centrale**, **PA locale**e **Tlc** rimangono i settori più colpiti ovvero rilevano il numero più alto di vittime di eventi cyber.

Inoltre, gli attacchi attribuibili all’hacktivism sono passati dal 49% del mese precedente al 31% degli eventi complessivi di novembre. “Interessante è infatti il calo dell’hacktivism, in controtendenza rispetto al **[Rapporto Clusit 2025](https://www.cybersecurity360.it/news/rapporto-clusit-2025-in-italia-lhactivism-soprattutto-pro-russia-supera-il-cyber-crime/)**, che indica l’hacktivismo come vettore dominante in Italia (54% degli attacchi noti nel primo semestre)”, secondo **Pierluigi Paganini**.
...
In questo ambito, **[attacchi DDoS](https://www.cybersecurity360.it/nuove-minacce/ddos-cosa-sono-questi-attacchi-hacker-e-come-stanno-evolvendo/)** sono sferrati contro siti internet di talune società di **gestione aeroportuale**, operanti su differenti scali nazionali: hanno causato temporaneamente inaccessibilità dei servizi web, indisponibilità che si limitano a intervalli di alcuni minuti.

“PA centrale e locale, trasporti e telecomunicazioni confermano che **il perimetro critico nazionale è ormai bersaglio strutturale**, con il DDoS che torna a essere rumore di fondo più che fenomeno straordinario, pur colpendo nodi sensibili come la gest...