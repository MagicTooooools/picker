---
title: La trappola di Chat Control: minori tutelati, cittadini sorvegliati
url: https://www.cybersecurity360.it/legal/privacy-dati-personali/la-trappola-di-chat-control-minori-tutelati-cittadini-sorvegliati/
source: Over Security - Cybersecurity news aggregator
date: 2025-11-28
fetch_date: 2025-11-29T03:15:53.170221
---
...
![Chat Control Consiglio UE approvato](data:image/png;base64...)![Chat Control Consiglio UE approvato](https://dnewpydm90vfx.cloudfront.net/wp-content/uploads/2025/11/Chat-Control-Consiglio-UE-approvato.jpg)

---

L’Unione Europea ha appena mosso un passo formale verso l’approvazione del controverso regolamento **per prevenire e contrastare gli abusi sessuali sui minori online**, giornalisticamente noto come [Chat control](https://www.cybersecurity360.it/cultura-cyber/chat-control-un-tavolo-tecnico-per-contrastare-gli-abusi-sui-minori-e-tutelare-le-liberta-digitali/). Il 26 novembre 2025, nella votazione tra i 27 Stati membri, è emersa una maggioranza (seppure labile) che sposa la [posizione del Consiglio](https://www.consilium.europa.eu/en/press/press-releases/2025/11/26/child-sexual-abuse-council-reaches-position-on-law-protecting-children-from-online-abuse/?utm_source=brevo&utm_campaign=AUTOMATED%20-%20Alert%20-%20Newsletter&utm_medium=email&utm_id=3318) sul **regolamento**.
...
Determinante per l’approvazione è stato l’accoglimento della posizione del [governo danese](https://it.euronews.com/next/2025/11/05/nuova-proposta-danese-sul-controllo-delle-chat-restano-tre-grossi-problemi) che ha proposto **l’eliminazione dell’obbligo di scansione automatica** delle chat, evitando così il voto contrario di un gruppo di paesi di cui facevano appunto parte anche Italia e Germania.
...
* [Prevedibilità e narrazioni alla base delle scelte sulla age verification](#Prevedibilita_e_narrazioni_alla_base_delle_scelte_sulla_age_verification)
* [Le scelte politiche](#Le_scelte_politiche)
* [Le alternative meno invasive e il fallimento della privacy by design](#Le_alternative_meno_invasive_e_il_fallimento_della_privacy_by_design)
  + [Le Zero-Knowledge Proofs (ZKP)](#Le_Zero-Knowledge_Proofs_ZKP)
  + [L’EUDI Wallet](#LEUDI_Wallet)
* [Chat Control come negazione della minimizzazione](#Chat_Control_come_negazione_della_minimizzazione)
* [L’obiettivo nascosto: una sorveglianza legittimata](#Lobiettivo_nascosto_una_sorveglianza_legittimata)
* [Il vantaggio competitivo delle Big Tech USA](#Il_vantaggio_competitivo_delle_Big_Tech_USA)
* [L’indebolimento della crittografia come rischio geopolitico](#Lindebolimento_della_crittografia_come_rischio_geopolitico)
* [Ripensare la tutela dei minori senza sacrificare la democrazia digitale](#Ripensare_la_tutela_dei_minori_senza_sacrificare_la_democrazia_d...